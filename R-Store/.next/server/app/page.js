...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7524)), "C:\\projects\\R-S\\frontend\\app\\page.js"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2756)), "C:\\projects\\R-S\\frontend\\app\\layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["C:\\projects\\R-S\\frontend\\app\\page.js"];
...
var lib = __webpack_require__(1347);
// EXTERNAL MODULE: ./node_modules/next/link.js
var next_link = __webpack_require__(1621);
var link_default = /*#__PURE__*/__webpack_require__.n(next_link);
;// CONCATENATED MODULE: ./app/Components/Navigation.js
...
const Navigation = ({ account, setAccount })=>{
    const connectHandler = async ()=>{
        ...
        const account = lib.ethers.utils.getAddress(accounts[0]);
        setAccount(account);
    };
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("nav", {
        children: [
            ...
            account ? /*#__PURE__*/ jsx_runtime_.jsx("button", {
                type: "button",
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("li", {
                        children: /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                            href: "#Clothing & Jewelry",
                            children: "Clothing & Jewelry"
                        })
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx("li", {
                        children: /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
...
;// CONCATENATED MODULE: ./assets/star-regular.svg
/* harmony default export */ const star_regular = ({"src":"/_next/static/media/star-regular.b6227be2.svg","height":512,"width":576,"blurWidth":0,"blurHeight":0});
// EXTERNAL MODULE: ./node_modules/next/image.js
var next_image = __webpack_require__(8421);
var image_default = /*#__PURE__*/__webpack_require__.n(next_image);
;// CONCATENATED MODULE: ./assets/star-solid.svg
/* harmony default export */ const star_solid = ({"src":"/_next/static/media/star-solid.f158001a.svg","height":512,"width":529,"blurWidth":0,"blurHeight":0});
;// CONCATENATED MODULE: ./app/Components/Rating.js
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
;// CONCATENATED MODULE: ./app/Components/Section.js
/* __next_internal_client_entry_do_not_use__ default auto */ 
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx(Components_Rating, {
                                        value: item.rating
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
                                        children: [
                                            lib.ethers.utils.formatUnits(item.cost.toString(), "ether"),
                                            " ETH"
                                        ]
                                    })
                                ]
...
/* harmony default export */ const assets_close = ({"src":"/_next/static/media/close.eef1a679.svg","height":512,"width":320,"blurWidth":0,"blurHeight":0});
;// CONCATENATED MODULE: ./app/Components/Product.js
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
const Product = ({ item, provider, account, retailX, togglePop })=>{
    ...
    const [hasBought, setHasBought] = (0,react_.useState)(false);
            ...
            children: [
                ...
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    children: [
                        ...
                        item.stock > 0 ? /*#__PURE__*/ jsx_runtime_.jsx("p", {
                            children: "In Stock."
                        }) : /*#__PURE__*/ jsx_runtime_.jsx("p", {
                        ...
                        order && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
...
function Home() {
    const [provider, setProvider] = (0,react_.useState)(null);
    const [account, setAccount] = (0,react_.useState)(null);
    const [retailX, setRetailX] = (0,react_.useState)(null);
    const [electronics, setElectronics] = (0,react_.useState)(null);
    const [clothing, setClothing] = (0,react_.useState)(null);
    const [toys, setToys] = (0,react_.useState)(null);
    const [item, setItem] = (0,react_.useState)({});
    ...
    const loadBlockchainData = async ()=>{
        ...
        const provider = new lib.ethers.providers.Web3Provider(window.ethereum);
        setProvider(provider);
        const network = await provider.getNetwork();
        console.log(network);
        // Connect to smart contracts
        const retailX = new lib.ethers.Contract(config_namespaceObject[network.chainId].retailX.address, RetailX_namespaceObject, provider);
        setRetailX(retailX);
        // Load products
        const items = [];
        for(let i = 0; i < 9; i++){
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                children: "RetailX Best Sellers"
            }),
            electronics && clothing && toys && /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
                children: [
            ...
            toggle && /*#__PURE__*/ jsx_runtime_.jsx(Components_Product, {
                item: item,
                provider: provider,
                account: account,
                retailX: retailX,
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\projects\R-S\frontend\app\page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,818], () => (__webpack_exec__(1811)));
